    ...
    <section className=" text-xl">
      ...
      <section className=" grid gap-4 sm:grid-cols-two">
        ...
        <article className=" bg-slate-300/70 rounded-3xl grid grid-cols-3 justify-center justify-items-stretch py-2  sm:grid-cols-1 sm:px-2 sm:py-0 ">
            <div className=" flex gap-2 text-sm justify-center items-center py-2">
                <div>
      ...
      <button onClick={changeUnitTemp}  className='bg-black py-2 px-6 text-white rounded-full hover:bg-blue-800 duration-200 font-bold text-sm  block mx-auto mt-4'>Change °C / °F</button>
    </section>
  );
};
